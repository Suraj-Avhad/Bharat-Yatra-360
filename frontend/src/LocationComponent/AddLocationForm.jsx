...
import { ToastContainer, toast } from "react-toastify"; //show pop up message(success/error)
import { useNavigate } from "react-router-dom";  // help to redirect to other page after saving
...
const AddLocationForm = () => {
  ...
  const saveLocation = (e) => {
    ...
    // api call using fetch - add location
